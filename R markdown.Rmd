...
```
To facet the plot on combination of two variables, add \textbf{facet_grid} to your plot call. The first argument of \textbf{} is also a formula. This time the formula should contain two variable names separated by a ~:
```{r}
ggplot(data = mpg)+
  geom_point(mapping = aes(x = displ, y = hwy)) +
  facet_grid(drv ~ cyl)
